  ...
  <div>
    ...
    <center>
      <v-flex xs12 class="card-margin">
        <v-card class="cardmenu" id="card-center" width="100%" height="100%">
          <v-toolbar color="white" class="box">
            <v-icon id="left" color="orange" style="font-size:40px">account_circle</v-icon>
            <h1 id="center">name</h1>
            <h1 class="text-color-red" id="right">NOT GO!</h1>
          </v-toolbar>
          <v-toolbar color="white" class="box">
            <v-icon id="left" color="orange" style="font-size:40px">account_circle</v-icon>
            <h1 id="center">name</h1>
            <h1 class="text-color-green" id="right">GO!</h1>
          </v-toolbar>
          <v-toolbar color="white" class="box">
            <v-icon id="left" color="orange" style="font-size:40px">account_circle</v-icon>
            <h1 id="center">name</h1>
    ...
    <v-footer fixed="app">
      <v-layout row wrap>
        <v-flex xs3 @click="$router.push('/indexDrive')">
          <v-card id="icon-center" width="100%" height="100%" @click="$router.push('/indexDrive')">
        ...
        <v-flex xs3 @click="$router.push('/statusDrive')">
          <v-card id="icon-center" @click="$router.push('/statusDrive')" color="orange">
